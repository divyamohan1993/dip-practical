"""
Practical 1 — Spatial Difference processing functions.
Handles image subtraction, histograms, comparison plots, matplotlib demos,
pixel inspection, step-by-step pipeline, surface plots, pixel arithmetic,
and bit-depth comparison.
"""
...
def generate_matplotlib_demo():
    ...
    fig.tight_layout()
    demos['subplot_layouts'] = fig_to_base64(fig)
    ...
    if img is not None:
        ...
        fig.tight_layout()
        demos['colormaps'] = fig_to_base64(fig)
    ...
    fig.tight_layout()
    demos['figure_customization'] = fig_to_base64(fig)
...
def generate_bit_depth_comparison(filename):
    ...
    for bits in bit_depths:
        ...
        fig.tight_layout()
        results[f"{bits}_bit"] = fig_to_base64(fig)
